...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                @include('services.generals.table')
            </div>
        </div>
    </div>
</div>
</div>
@include('services.generals.templates.templates')
</div>
@endsection
...
@section('scripts')
<script>
    let generalUrl = "{{url('services/generals')}}";
    let patientUrl = "{{ url('patients') }}";
    let medicUrl = "{{ url('medics') }}";
</script>
<script src="{{ mix('assets/js/services/generals/generals.js') }}"></script>
