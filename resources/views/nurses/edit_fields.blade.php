<div class="row">
    ...
    <div class="form-group col-sm-6 col-md-4">
        <div class="row">
            ...
            <div class="col-6">
                <div class="col-sm-4 preview-image-video-container pl-0 mt-1 pl-md-2">
...
<div class="row mt-3">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {{ Form::text('zip', isset($nurse->address->zip) ? $nurse->address->zip : null, ['class' => 'form-control','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'maxlength' => '6','minlength' => '6']) }}
        </div>
    </div>
