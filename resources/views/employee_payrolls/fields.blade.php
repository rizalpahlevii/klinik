<div class="row">
    <div class="col-lg-2 col-md-4 col-sm-12">
        <div class="form-group">
            ...
            {{ Form::text('sr_no', $srNo, ['class' => 'form-control','required','readonly']) }}
        </div>
    </div>
    <div class="col-lg-2 col-md-4 col-sm-12">
        <div class="form-group">
            {{ Form::label('payroll_id', __('messages.employee_payroll.payroll_id').(':')) }}<span
                    class="required">*</span>
            {{ Form::text('payroll_id', $payrollId, ['class' => 'form-control','required','readonly']) }}
        </div>
    </div>
    <div class="col-lg-2 col-md-4 col-sm-12">
        <div class="form-group">
            {{ Form::label('type', __('messages.employee_payroll.role').(':')) }}<span class="required">*</span>
            {{ Form::select('type', $types, null, ['id' => 'type','class' => 'form-control','required','placeholder' => 'Select Role']) }}
        </div>
    </div>
    <div class="col-lg-2 col-md-4 col-sm-12">
        <div class="form-group">
            {{ Form::label('owner_id', __('messages.employee_payroll.employee').(':')) }}<span
                    class="required">*</span>
            {{ Form::select('owner_id', [null], null, ['id' => 'ownerType','class' => 'form-control','required','disabled']) }}
        </div>
    </div>
    <div class="col-lg-2 col-md-4 col-sm-12">
        <div class="form-group">
            {{ Form::label('month', __('messages.employee_payroll.month').(':')) }}<span class="required">*</span>
            {{ Form::selectMonth('month', ['id' => 'month','class' => 'form-control','required']) }}
        </div>
    </div>
    <div class="col-lg-2 col-md-4 col-sm-12">
        <div class="form-group">
