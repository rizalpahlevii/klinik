    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            ...
            <div class="page-header">
                <h3 class="page__heading">{{ __('messages.lab_technicians') }}</h3>
                <div class="filter-container">
                    ...
                    <div class="mr-0 actions-btn">
                        <div class="btn-group" role="group">
                            <button id="labTechniciansActions" type="button" class="btn btn-primary dropdown-toggle"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Actions
                            </button>
                            <div class="dropdown-menu" aria-labelledby="labTechniciansActions"
                                 x-placement="bottom-start">
                                <a href="{{ route('lab-technicians.create') }}" class="dropdown-item">
                                    {{ __('messages.lab_tech.new_lab_tech') }}
                                </a>
                                <a href="{{ route('lab.technicians.excel') }}" class="dropdown-item">
