<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::text('dob', null, ['id'=>'birthDate', 'class' => 'form-control','autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
    ...
    <div class="form-group col-sm-6 col-md-4">
        <div class="row">
            <div class="col-4">{{ Form::label('image', __('messages.common.profile').':') }}
                <label class="image__file-upload" tabindex="9"> {{ __('messages.nurse.choose') }}
...
<div class="row mt-3">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::text('address1', isset($labTechnician->address->address1) ? $labTechnician->address->address1 : null, ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            {{ Form::label('address2', __('messages.user.address2').':') }}
            {{ Form::text('address2', isset($labTechnician->address->address2) ? $labTechnician->address->address2 : null, ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            {{ Form::label('city', __('messages.user.city').':') }}
            {{ Form::text('city', isset($labTechnician->address->city) ? $labTechnician->address->city : null, ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            {{ Form::label('zip', __('messages.user.zip').':') }}
            {{ Form::text('zip', isset($labTechnician->address->zip) ? $labTechnician->address->zip : null, ['class' => 'form-control','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'maxlength' => '6','minlength' => '6']) }}
        </div>
    </div>
    <div class="form-group col-sm-12">
        {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary']) }}
        <a href="{{ route('lab-technicians.index') }}" class="btn btn-secondary">{{ __('messages.common.cancel') }}</a>
    </div>
</div>
