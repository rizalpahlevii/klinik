<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {{ Form::label('product_name', __('Nama Obat').':') }}<span class="required">*</span>
            {{ Form::text('product_name', $product->name, ['class' => 'form-control','required']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="category_id">Kategori Obat <span class="required"></span></label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="brand_id">Merek Obat <span class="required">*</span></label>
            <select name="brand_id" id="brand_id" class="form-control">
                <option disabled selected>Pilih Merek Obat</option>
