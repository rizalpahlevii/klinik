    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <label class="switch switch-label switch-outline-primary-alt swich-center">
                <input name="is_active" class="switch-input is-active" type="checkbox"
    ...
    <div class="form-group col-sm-6 col-md-4">
        <div class="row">
            <div class="col-4">{{ Form::label('image',__('messages.common.profile').(':')) }}
                <label class="image__file-upload" tabindex="9"> Choose
...
<div class="row mt-3">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::text('address1', isset($pharmacist->address->address1) ? $pharmacist->address->address1 : null, ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            {{ Form::label('address2',__('messages.user.address2').(':')) }}
            {{ Form::text('address2', isset($pharmacist->address->address2) ? $pharmacist->address->address2 : null, ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            {{ Form::label('city',__('messages.user.city').(':')) }}
            {{ Form::text('city', isset($pharmacist->address->city) ? $pharmacist->address->city : null, ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            {{ Form::label('zip',__('messages.user.zip').(':')) }}
            {{ Form::text('zip', isset($pharmacist->address->zip) ? $pharmacist->address->zip : null, ['class' => 'form-control','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'maxlength' => '6','minlength' => '6']) }}
        </div>
    </div>
