    ...
    <div class="col-md-4 col-sm-12">
        <div class="form-group">
            {!! Form::label('item_category_id', __('messages.item_stock.item_category').':') !!}<span
                    class="required">*</span>
            {{ Form::select('item_category_id', $itemCategories, $itemStock->item_category_id, ['id' => 'itemCategory','class' => 'form-control','required','placeholder' => 'Select Item Category']) }}
        </div>
    </div>
    <div class="col-md-4 col-sm-12">
        <div class="form-group">
            {!! Form::label('item_id', __('messages.item_stock.item').':') !!}<span
                    class="required">*</span>
            {{ Form::select('item_id', [null], $itemStock->item_id, ['id' => 'items','class' => 'form-control','required']) }}
        </div>
    </div>
    <div class="col-md-4 col-sm-12">
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-2 mt-1">
                    <img id='previewImage' class="img-thumbnail thumbnail-preview image-stretching"
                         src="{{ !empty($itemStock->item_stock_url) ? $itemStock->item_stock_url : asset('assets/img/default_image.jpg') }}"/>
                </div>
            </div>
        </div>
    </div>
