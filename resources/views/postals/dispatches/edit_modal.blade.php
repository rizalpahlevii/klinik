    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('messages.postal.edit_dispatch')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        {{ Form::label('To Title',__('messages.postal.to_title').':') }}<span class="required">*</span>
                        {{ Form::text('to_title', null, ['class' => 'form-control','required','id' => 'editToTitle']) }}
                    </div>
                    <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        {{ Form::label('From Title',__('messages.postal.from_title').':') }}
                        {{ Form::text('from_title', null, ['class' => 'form-control','id' => 'editFromTitle']) }}
                    </div>
