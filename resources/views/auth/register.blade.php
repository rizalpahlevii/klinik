    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#register"><h4>Register</h4></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-enquiry" data-toggle="tab" href="#enquiry"><h4>Enquiry</h4></a>
                </li>
            </ul>
            <!-- Tab panes -->
                ...
                <div class="tab-pane container active" id="register">
                    <div class="col-md-12">
                        <form method="post" action="{{ url('/register') }}">
                            ...
                            <a href="{{ url('/login') }}" class="text-center pt-5">I already have an account</a>
                        </form>
                    </div>
                </div>
