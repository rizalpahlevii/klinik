                ...
                <div class="card-body">
                    <form method="post" action="{{ url('/login') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control {{ $errors->any()?'is-invalid':'' }}" name="username"
                                value="{{ (Cookie::get('username') !== null) ? Cookie::get('username') : old('username') }}"
                        ...
                        <div class="input-group mb-4">
                            ...
                            <input type="password" class="form-control {{ $errors->any()?'is-invalid':'' }}"
