    <div class="row">
        ...
        <div class="form-group col-sm-6">
            {{ Form::label('department_name', __('messages.doctor_department.doctor_department').':') }}<label
                    class="required">*</label>
            {{ Form::select('doctor_department_id',$doctorsDepartments, $doctor->doctor_department_id, ['class' => 'form-control','required','id' => 'doctorDepartmentId','placeholder'=>'Select Department']) }}
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('specialist', __('messages.doctor.specialist').':') }}<span class="required">*</span>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {{ Form::text('zip', isset($doctor->address->zip) ? $doctor->address->zip : null, ['class' => 'form-control','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'maxlength' => '6','minlength' => '6']) }}
        </div>
    </div>
