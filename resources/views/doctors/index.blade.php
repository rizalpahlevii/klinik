    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            ...
            <div class="page-header">
                <h3 class="page__heading">{{ __('messages.doctors') }}</h3>
                <div class="filter-container">
                    ...
                    <div class="mr-0 actions-btn">
                        <div class="btn-group" role="group">
                            <button id="doctorActions" type="button" class="btn btn-primary dropdown-toggle"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Actions
                            </button>
                            <div class="dropdown-menu" aria-labelledby="doctorActions" x-placement="bottom-start">
                                <a href="{{ route('doctors.create') }}" class="dropdown-item">
                                    {{ __('messages.doctor.new_doctor') }}
                                </a>
                                @if(Auth::user()->hasRole('Admin|Receptionist'))
                                    <a href="{{ route('doctors.excel') }}" class="dropdown-item">
