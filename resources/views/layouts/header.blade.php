<header class="app-header navbar">
    ...
    <ul class="nav navbar-nav ml-auto">
            ...
            <div class="dropdown-menu dropdown-menu-right ml-4 dropdown-menu-width" id="dropdown">
                <div class="dropdown-header">{{ __('messages.notification.notifications') }}
                    <div class="float-right">
                        ...
                        <a href="#" class="read-all-notification"
                ...
                <div class="dropdown-list-content dropdown-list-icons force-scroll">
                    ...
                    <a href="#" data-id="{{ $notification->id }}" class="dropdown-item notification" id="notification">
                        <div class="dropdown-item-desc">
                            <i class="{{ getNotificationIcon($notification->type) }}"></i>
                            <span data-toggle="tooltip" data-placement="top" data-delay='{"show":"500", "hide":"50"}'
        ...
        <li class="nav-item dropdown header-navbar">
            <a class="nav-link margin-right" id="loginUserName" data-toggle="dropdown" href="#" role="button"
