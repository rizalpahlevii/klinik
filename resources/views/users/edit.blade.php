                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control @error('address_form') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label for="phone_form">No.Telp Pengguna</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('username') is-invalid @enderror"
                                            name="username_form" id="username_form" value="{{ $user->username }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password"
                                            ...
                                            id="password" placeholder="Optional jika ingin mengganti password">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password"
                                            ...
                                            placeholder="Optional jika ingin mengganti password">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
