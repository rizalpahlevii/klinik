...
<div class="row mt-3">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {{ Form::text('zip', isset($receptionist->address->zip) ? $receptionist->address->zip : null, ['class' => 'form-control','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'maxlength' => '6','minlength' => '6']) }}
        </div>
    </div>
    <div class="form-group col-sm-12">
        {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary']) }}
        <a href="{{ route('receptionists.index') }}" class="btn btn-secondary">{{__('messages.common.cancel')}}</a>
    </div>
</div>
