    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            ...
            <div class="page-header">
                <h3 class="page__heading">{{__('messages.receptionist.receptionists')}}</h3>
                <div class="filter-container">
                    ...
                    <div class="mr-0 actions-btn">
                        <div class="btn-group" role="group">
                            <button id="receptionistsActions" type="button" class="btn btn-primary dropdown-toggle"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Actions
                            </button>
                            <div class="dropdown-menu" aria-labelledby="receptionistsActions"
                                 x-placement="bottom-start">
                                <a href="{{ route('receptionists.create') }}" class="dropdown-item">
                                    {{ __('messages.receptionist.new_receptionist') }}
                                </a>
                                <a href="{{ route('receptionists.excel') }}" class="dropdown-item">
...
@section('scripts')
    <script>
        let receptionistUrl = "{{url('receptionists')}}";
    </script>
