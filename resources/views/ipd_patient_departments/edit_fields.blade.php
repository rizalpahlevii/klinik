<div class="row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="form-group">
            ...
            {{ Form::number('weight', 0, ['class' => 'form-control', 'max' => '200', 'step' => '.01', 'data-mask'=>'##0,00']) }}
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <label class="switch switch-label switch-outline-primary-alt swich-center">
                <input name="is_old_patient" class="switch-input is-active" type="checkbox"
                       value="1" {{ ($ipdPatientDepartment->is_old_patient) ? 'checked' : '' }}>
    ...
    <div class="form-group col-sm-12">
        {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary', 'id' => 'btnIpdPatientEdit']) }}
