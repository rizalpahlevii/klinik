<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            {{ Form::label('case_id', __('messages.ipd_patient.case_id').':') }}
            {{ Form::select('case_id', [null], null, ['class' => 'form-control','id' => 'caseId', 'disabled']) }}
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {{ Form::number('height', 0, ['class' => 'form-control', 'max' => '7', 'step' => '.01']) }}
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
            {{ Form::label('weight', __('messages.ipd_patient.weight').':') }}
            {{ Form::number('weight', 1, ['class' => 'form-control', 'max' => '200', 'step' => '.01']) }}
        </div>
    </div>
    <div class="col-md-2 p-lg-0 p-md-0 no-gutters">
        <div class="form-group">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <label class="switch switch-label switch-outline-primary-alt swich-center">
                <input name="is_old_patient" class="switch-input is-active" type="checkbox"
