...
var tableName = '#bedAssignsTbl';
var tbl = $('#bedAssignsTbl').DataTable({
  processing: true,
  serverSide: true,
  'order': [[3, 'desc']],
  ajax: {
  ...
  columns: [{
    ...
    data: function data(row) {
      var showLink = bedUrl + '/' + row.bed.id;
      return '<a href="' + showLink + '">' + row.bed.name + '</a>';
    },
    name: 'bed.name'
  }, {
    data: function data(row) {
      var showLink = caseUrl + '/' + row.case_from_bed_assign.id;
...
$(document).on('click', '.delete-btn', function (event) {
  var bedAssignId = $(event.currentTarget).data('id');
...
/***/ 60:
/*!************************************************************!*\
  !*** multi ./resources/assets/js/bed_assign/bed_assign.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/bed_assign/bed_assign.js */"./resources/assets/js/bed_assign/bed_assign.js");
