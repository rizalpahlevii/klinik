...
var tbl = $('#deathReportsTbl').DataTable({
  processing: true,
  serverSide: true,
  'order': [[3, 'desc']],
  ajax: {
  ...
  columns: [{
    ...
    data: function data(row) {
      var showLink = caseUrl + '/' + row.case_from_death_report.id;
    ...
    data: function data(row) {
      var url = deathReportUrl + '/' + row.id;
      var data = [{
        'id': row.id,
        'url': url + '/edit',
        'viewUrl': url
      }];
      return prepareTemplateRender('#deathReportActionTemplate', data);
    },
    name: 'id'
  }, {
...
$(document).on('click', '.delete-btn', function (event) {
  var deathReportId = $(event.currentTarget).data('id');
...
/***/ 62:
/*!******************************************************************!*\
  !*** multi ./resources/assets/js/death_reports/death_reports.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/death_reports/death_reports.js */"./resources/assets/js/death_reports/death_reports.js");
