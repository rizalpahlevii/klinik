...
var tableName = "#patientsTable";
var tbl = $("#patientsTable").DataTable({
  processing: true,
  serverSide: true,
  order: [[1, "asc"]],
  ajax: {
  ...
  columns: [{
    ...
    data: function data(row) {
      var showLink = patientUrl + "/" + row.id;
...
/***/ 7:
/*!********************************************************!*\
  !*** multi ./resources/assets/js/patients/patients.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\projects\klinik\resources\assets\js\patients\patients.js */"./resources/assets/js/patients/patients.js");
