...
$(document).ready(function () {
  ...
  $(document).on('click', '.edit-btn', function (event) {
    ...
    ajaxCallInProgress();
    var chargeTypeId = $(event.currentTarget).data('id');
  ...
  window.renderData = function (id) {
    $.ajax({
      ...
      success: function success(result) {
        if (result.success) {
          $('#chargeTypeId').val(result.data.id);
...
/***/ 119:
/*!********************************************************************!*\
  !*** multi ./resources/assets/js/charge_categories/create-edit.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/charge_categories/create-edit.js */"./resources/assets/js/charge_categories/create-edit.js");
