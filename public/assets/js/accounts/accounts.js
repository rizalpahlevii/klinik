...
$(tableName).DataTable({
  ...
  ajax: {
    ...
    data: function data(_data) {
      _data.account_status = $('#filter_status').find('option:selected').val();
      _data.account_type = $('#filter_type').find('option:selected').val();
    }
  },
  columnDefs: [{
    'targets': [2, 3],
  ...
  columns: [{
    data: function data(row) {
      var showLink = accountUrl + '/' + row.id;
...
$(document).on('change', '.is-active', function (event) {
  var accountId = $(event.currentTarget).data('id');
...
module.exports = __webpack_require__(/*! C:\laragon\www\klinik\resources\assets\js\accounts\accounts.js */"./resources/assets/js/accounts/accounts.js");
