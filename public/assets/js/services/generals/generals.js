...
var tableName = "#generalsTable";
var tbl = $("#generalsTable").DataTable({
  processing: true,
  serverSide: true,
  order: [[1, "asc"]],
  ajax: {
  ...
  columns: [{
    data: function data(row) {
      var showLink = generalUrl + "/" + row.id;
...
$(document).on("click", ".delete-btn", function (event) {
  var generalId = $(event.currentTarget).data("id");
...
/***/ 20:
/*!*****************************************************************!*\
  !*** multi ./resources/assets/js/services/generals/generals.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/services/generals/generals.js */"./resources/assets/js/services/generals/generals.js");
