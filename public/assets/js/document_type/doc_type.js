...
$(tableName).DataTable({
  ...
  columns: [{
    data: function data(row) {
      var showLink = docTypeUrl + '/' + row.id;
...
$(document).on('click', '.edit-btn', function (event) {
  ...
  ajaxCallInProgress();
  var docTypeId = $(event.currentTarget).data('id');
...
/***/ 55:
/*!*************************************************************!*\
  !*** multi ./resources/assets/js/document_type/doc_type.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/document_type/doc_type.js */"./resources/assets/js/document_type/doc_type.js");
