...
var tbl = $('#bloodBankTable').DataTable({
  processing: true,
  serverSide: true,
  'order': [[1, 'desc']],
  ajax: {
...
$(document).on('click', '.edit-btn', function (event) {
  ...
  ajaxCallInProgress();
  var bloodGroupId = $(event.currentTarget).data('id');
  renderData(bloodGroupId);
});
$(document).on('click', '.delete-btn', function (event) {
  var bloodGroupId = $(event.currentTarget).data('id');
  deleteItem(bloodBankUrl + '/' + bloodGroupId, '#bloodBankTable', 'Blood Group');
});
...
/***/ 46:
/*!**************************************************************!*\
  !*** multi ./resources/assets/js/blood_banks/blood_banks.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/blood_banks/blood_banks.js */"./resources/assets/js/blood_banks/blood_banks.js");
