...
$(tableName).DataTable({
  ...
  columns: [{
    ...
    data: function data(row) {
      var editLink = opdPatientUrl + '/' + row.id + '/edit';
      var data = [{
        'id': row.id,
        'url': editLink
      }];
...
/***/ 169:
/*!**********************************************************!*\
  !*** multi ./resources/assets/js/opd_patients/visits.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/opd_patients/visits.js */"./resources/assets/js/opd_patients/visits.js");
