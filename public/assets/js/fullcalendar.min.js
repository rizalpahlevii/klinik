 ...
 */
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = e(require("moment"), require("jquery")) : "function" == typeof define && define.amd ? define(["moment", "jquery"], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.FullCalendar = e(require("moment"), require("jquery")) : t.FullCalendar = e(t.moment, t.jQuery);
  ...
  return function (t) {
    ...
    function X(t, e) {
      ...
      if (e) for (n = 0; n < e.length; n++) {
        for (r = e[n], i = [], o = t.length - 1; o >= 0; o--) {
          if ("object" == _typeof(s = t[o][r])) i.unshift(s);else if (void 0 !== s) {
            l[r] = s;
            break;
          }
        }
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.parse = function (t, e) {
        var n = new this(e);
        return !("object" != _typeof(t) || !n.applyProps(t)) && n;
    ...
    Object.defineProperty(e, "__esModule", {
      ...
      sourceClasses: [],
      registerClass: function registerClass(t) {
    ...
    var r = n(3),
      ...
      return t.prototype.opt = function (t) {
        ...
        for (e in t) {
          n = t[e], r = n.sliceRenderRanges(i.activeUnzonedRange), n.getEventDef().hasBgRendering() ? o.push.apply(o, r) : s.push.apply(s, r);
        }
        ...
        this.fillRenderer.renderSegs("bgEvent", t, {
          getClasses: function getClasses(t) {
    ...
    function c(t) {
      ...
      for (e = 0; e < t.length; e++) {
        n = t[e], "string" == typeof n ? r.push("[" + n + "]") : n.token ? n.token in E ? r.push(b + "[" + n.token + "]") : r.push(n.token) : n.maybe && r.push(w + c(n.maybe) + w);
      }
    ...
    function p(t) {
      ...
      for (e = 0; e < t.length; e++) {
        n = t[e], n.token ? (r = S[n.token.charAt(0)], i.push(r ? r.unit : "second")) : n.maybe ? i.push.apply(i, p(n.maybe)) : i.push(null);
      }
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.watch = function (t) {
        ...
        for (e in t) {
          "object" != _typeof(n = t[e]) && n === this._props[e] || (r[e] = n, i++);
        }
        ...
        if (i) {
          ...
          for (e in r) {
            n = r[e], this.trigger("before:change", e, n), this.trigger("before:change:" + e, n);
          }

          for (e in r) {
            n = r[e], void 0 === n ? delete this._props[e] : this._props[e] = n, this.trigger("change:" + e, n), this.trigger("change", e, n);
          }
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.isAllDay = function () {
        ...
        for (var e, n, r, i = this.source.calendar, o = t.getStart(), s = t.getEnd(), u = []; o.isBefore(s);) {
          this.dowHash && !this.dowHash[o.day()] || (e = i.applyTimezone(o), n = e.clone(), r = null, this.startTime ? n.time(this.startTime) : n.stripTime(), this.endTime && (r = e.clone().time(this.endTime)), u.push(new a["default"](this, new l["default"](n, r, i)))), o.add(1, "days");
        }
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.parse = function (t, e) {
        ...
        var r,
            i = this.eventDefs;
        if (null != this.currentTimezone && this.currentTimezone !== n) for (r = 0; r < i.length; r++) {
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.updateDayTable = function () {
        for (var t, e, n, r = this, i = r.view, o = i.calendar, s = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.startMs, !0), a = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.endMs, !0), l = -1, u = [], d = []; s.isBefore(a);) {
          i.isHiddenDay(s) ? u.push(l + .5) : (l++, u.push(l), d.push(s.clone())), s.add(1, "days");
        }
        ...
        for (e = 0; e < this.rowCnt; e++) {
          n = e * s, r = n + s - 1, i = Math.max(l, n), o = Math.min(u, r), i = Math.ceil(i), o = Math.floor(o), i <= o && d.push({
            row: e,
        ...
        for (e = 0; e < this.rowCnt; e++) {
          for (n = e * a, r = n + a - 1, i = n; i <= r; i++) {
            o = Math.max(u, i), s = Math.min(d, i), o = Math.ceil(o), s = Math.floor(s), o <= s && c.push({
              row: e,
    ...
    var r = n(9),
      ...
      return t.prototype.renderComponentFootprint = function (t) {
        ...
        if (null != r) for (i = 0; i < o.length; i++) {
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.componentFootprintToSegs = function (t) {
        ...
        var n,
            ...
            E = function E(n) {
          for (; D < n;) {
            l = m.getCellSegs(t, D, e), l.length && (c = r[e - 1][D], y = m.renderMoreLink(t, D, l), v = i("<div>").append(y), c.append(v), w.push(v[0])), D++;
          }
        };
        ...
        for (n = 0; n < t.length; n++) {
          r = t[n], (o = r.footprint.componentFootprint.unzonedRange.intersect(c)) && p.push(i.extend({}, r, {
    ...
    var o = n(5),
      ...
      return t.prototype.opt = function (t) {
        ...
        var n;
        return "businessHours" === t ? this.buildCurrentBusinessFootprints(e) : "object" == _typeof(t) ? (n = this.parseEventDefToInstances(t), n ? this.eventInstancesToFootprints(n) : this.parseFootprints(t)) : null != t ? (n = this.eventManager.getEventInstancesWithId(t), this.eventInstancesToFootprints(n)) : void 0;
    ...
    var r = n(3),
      ...
      return t.prototype.buildEventInstanceGroup = function (t, e) {
        ...
        for (!0 === n ? i = [{}] : r.isPlainObject(n) ? i = [n] : r.isArray(n) && (i = n, o = !0), e = 0; e < i.length; e++) {
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.queue = function (t, e, n) {
        ...
        var e,
            ...
            r = this.q,
            i = !0;
        if (t.namespace && "destroy" === t.type) for (e = r.length - 1; e >= 0; e--) {
    ...
    var i = n(3),
      ...
      return t.prototype.constructed = function () {}, t.prototype.getView = function () {
        ...
        } else "object" == _typeof(t) && this.optionsManager.add(t);
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.end = function () {
        ...
        var g = this.dragListener = new l["default"](a, {
          ...
          subjectEl: p,
          subjectCenter: !0,
          interactionStart: function interactionStart(r) {
          ...
          interactionEnd: function interactionEnd(i) {
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.end = function () {
        ...
        return new o["default"](n, {
          ...
          hitOver: function hitOver(r, o, s) {
            var a, l;
          ...
          interactionEnd: function interactionEnd(n, r) {
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.end = function () {
        ...
        var t,
          ...
          hitOver: function hitOver(e, n, r) {
            n || (t = null);
          },
          hitOut: function hitOut() {
            t = null;
          },
          interactionEnd: function interactionEnd(r, i) {
            var o;
    ...
    var i,
      ...
      return s.__extends(e, t), e.prototype.instantiateTimeGrid = function () {
        ...
        for (e in t) {
          n = t[e], n.getEventDef().isAllDay() ? r[e] = n : i[e] = n;
        }
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.componentFootprintToSegs = function (t) {
        ...
        for (e = 0; e < t.length; e++) {
          n = t[e], r = this.dayDates[n.dayIndex], n.top = this.computeDateTop(n.startMs, r), n.bottom = Math.max(n.top + i, this.computeDateTop(n.endMs, r));
        }
    ...
    var l = n(2),
      ...
      return l.__extends(e, t), e.prototype.renderFgSegs = function (t) {
        ...
        var r,
            i = t.forwardSegs;
        if (void 0 === t.forwardCoord) for (i.length ? (this.sortForwardSegs(i), this.computeFgSegForwardBack(i[0], e + 1, n), t.forwardCoord = i[0].backwardCoord) : t.forwardCoord = 1, t.backwardCoord = t.forwardCoord - (t.forwardCoord - n) / (e + 1), r = 0; r < i.length; r++) {
        ...
        for (e = 0; e < t.length; e++) {
          n = t[e], n.el.css(this.generateFgSegHorizontalCss(n)), n.footprint.eventDef.title && n.bottom - n.top < 30 && n.el.addClass("fc-short");
        }
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.renderSegs = function (t, e) {
        ...
        for (this.eventRenderer.renderFgSegsIntoContainers(t, this.component.helperContainerEls), n = 0; n < t.length; n++) {
          r = t[n], e && e.col === r.col && (o = e.el, r.el.css({
            left: o.css("left"),
            right: o.css("right"),
    ...
    var o = n(2),
      ...
      return o.__extends(e, t), e.prototype.renderBgRanges = function (e) {
        ...
        function n(t) {
          for (; o < t;) {
            d = (y[r - 1] || [])[o], d ? d.attr("rowspan", parseInt(d.attr("rowspan") || 1, 10) + 1) : (d = s("<td>"), a.append(d)), v[r][o] = d, y[r][o] = d, o++;
          }
        }
    ...
    var r = n(2),
      ...
      return r.__extends(e, t), e.prototype.renderSkeleton = function () {
        ...
        for (e = 0; e < o.length; e++) {
          if (n = o[e]) for (a.append(this.dayHeaderHtml(this.dayDates[e])), this.eventRenderer.sortEventSegs(n), r = 0; r < n.length; r++) {
            a.append(n[r].el);
          }
        }
      ...
      return t.prototype.setToolbarOptions = function (t) {
        ...
        return u && r.each(u.split(" "), function (t, s) {
          ...
          r.each(s.split(","), function (t, s) {
            ...
            "title" === s ? (h = h.add(r("<h2>&nbsp;</h2>")), f = !1) : ((l = d[s]) ? (g = function g(t) {
