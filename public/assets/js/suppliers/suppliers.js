...
var tbl = $("#suppliersTable").DataTable({
  processing: true,
  serverSide: true,
  order: [[1, "asc"]],
  ajax: {
  ...
  columns: [{
    ...
    data: function data(row) {
      var showLink = supplierUrl + "/" + row.id;
...
$(document).on("click", ".delete-btn", function (event) {
  var supplierId = $(event.currentTarget).data("id");
...
/***/ 12:
/*!**********************************************************!*\
  !*** multi ./resources/assets/js/suppliers/suppliers.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\klinik\resources\assets\js\suppliers\suppliers.js */"./resources/assets/js/suppliers/suppliers.js");
