...
var tbl = $('#prescriptionsTable').DataTable({
  ...
  columns: [{
    ...
    data: function data(row) {
      ...
      return prepareTemplateRender('#prescriptionStatusTemplate', data);
    },
    name: 'status'
  }, {
    data: function data(row) {
      var url = prescriptionUrl + '/' + row.id;
      var showUrl = prescriptionUrl + '/' + row.id;
      var data = [{
        'id': row.id,
        'url': url + '/edit',
        'showUrl': showUrl
      }];
      return prepareTemplateRender('#prescriptionActionTemplate', data);
    },
...
$(document).on('click', '.delete-btn', function (event) {
  var prescriptionId = $(event.currentTarget).data('id');
  deleteItem(prescriptionUrl + '/' + prescriptionId, '#prescriptionsTable', 'Prescription');
});
...
/***/ 111:
/*!******************************************************************!*\
  !*** multi ./resources/assets/js/prescriptions/prescriptions.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/prescriptions/prescriptions.js */"./resources/assets/js/prescriptions/prescriptions.js");
