...
$(document).ready(function () {
  ...
  var tbl = $(tableName).DataTable({
    ...
    ajax: {
      ...
      data: function data(_data) {
        _data.expense_head = $('#expenseHead').find('option:selected').val();
      }
    },
    columnDefs: [{
      'targets': [0],
    ...
    columns: [{
      ...
      data: function data(row) {
        var showLink = expenseUrl + '/' + row.id;
  ...
  $(document).on('click', '.edit-btn', function (event) {
    ...
    ajaxCallInProgress();
    var expenseId = $(event.currentTarget).data('id');
...
/***/ 129:
/*!********************************************************!*\
  !*** multi ./resources/assets/js/expenses/expenses.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/expenses/expenses.js */"./resources/assets/js/expenses/expenses.js");
