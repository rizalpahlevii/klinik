...
var tableName = '#casesTbl';
var tbl = $('#casesTbl').DataTable({
  processing: true,
  serverSide: true,
  'order': [[1, 'desc']],
  ajax: {
  ...
  columns: [{
    ...
    data: function data(row) {
      ...
      return ' <label class="switch switch-label switch-outline-primary-alt switch-center">' + '<input name="status" data-id="' + row.id + '" class="switch-input status" type="checkbox" value="1" ' + checked + '>' + '<span class="switch-slider" data-checked="&#x2713;" data-unchecked="&#x2715;"></span>' + '</label>';
    },
    name: 'status'
  }, {
    data: function data(row) {
      var url = casesUrl + '/' + row.id;
      var data = [{
        'id': row.id,
        'url': url + '/edit'
      }];
...
$(document).on('click', '.delete-btn', function (event) {
  var caseId = $(event.currentTarget).data('id');
...
/***/ 72:
/*!******************************************************************!*\
  !*** multi ./resources/assets/js/patient_cases/patient_cases.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/rizal-ganeshahusada/resources/assets/js/patient_cases/patient_cases.js */"./resources/assets/js/patient_cases/patient_cases.js");
