...
class PatientRepository extends BaseRepository
{
    ...
    {
        $patientData = Patient::with('bills', 'invoices', 'appointments.doctor.user', 'admissions.doctor.user',
            'cases.doctor.user', 'advancedpayments', 'documents.documentType', 'user', 'vaccinations.vaccination',
            'address')->find($patientId);
