...
{
    /** @var  BirthReportRepository $birthReportRepository */
    ...
    {
        if ($request->ajax()) {
            return Datatables::of((new BirthReportDataTable())->get())->make(true);
        }
    ...
    {
        return view('birth_reports.show')->with('birthReport', $birthReport);
    }
