...
{
    /** @var  DeathReportRepository $deathReportRepository */
    ...
    {
        if ($request->ajax()) {
            return Datatables::of((new DeathReportDataTable())->get())->make(true);
        }
    ...
    {
        return view('death_reports.show')->with('deathReport', $deathReport);
    }
