...
{
    /** @var  AmbulanceCallRepository $ambulanceCallRepository */
    private $ambulanceCallRepository;

    /** @var  AmbulanceRepository $ambulanceRepository */
    ...
    {
        if ($request->ajax()) {
            return DataTables::of((new AmbulanceCallDataTable())->get())->make(true);
        }
